        ...
        <el-form :inline="true"   class="demo-form-inline" size="small">
          ...
          <el-form-item :label="$t('level_2_directory')+' : '" >
            <el-select  :placeholder="$t('optional')" class="cat" v-model="cat_id2" @change="get_cat3">
              <el-option v-for="cat in cat2 " :key="cat.catname" :label="cat.catname" :value="cat.ID"></el-option>
              <div v-if="cat2"></div>
            </el-select>
          </el-form-item>
          <el-form-item :label="$t('level_3_directory')+' : '" >
            <el-select  :placeholder="$t('optional')" class="cat" v-model="cat_id3">
              <el-option v-for="cat in cat3 " :label="cat.catname" :key="cat.catname" :value="cat.ID"></el-option>
              <div v-if="cat3"></div>
            </el-select>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    get_cat2 (item_id) {
      var that = this
      var url = this.DocConfig.server + '/secondCatList'
      var params = new URLSearchParams()
    ...
    get_cat3 (cat_id, callback) {
      var that = this
      var url = this.DocConfig.server + '/childCatList'
      var params = new URLSearchParams()
