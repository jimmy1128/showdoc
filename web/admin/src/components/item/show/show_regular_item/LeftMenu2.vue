...
style="height: 600px"
    ...
    <el-dropdown trigger="click" placement="top" size="200px" style="position: absolute; bottom: 0 " >
      <el-card class="box-cards" >
      <span class="el-dropdown-link btn1">
        {{$t("language")}}<i class="el-icon-arrow-down el-icon--right"></i>
      </span>
      </el-card>
      <el-dropdown-menu slot="dropdown" >
        <el-dropdown-item><router-link to="/user/setting">{{$t("english")}}</router-link></el-dropdown-item>
        <el-dropdown-item><router-link to="/attachment/index">{{$t("chinese_simplified")}}</router-link></el-dropdown-item>
      </el-dropdown-menu>
    </el-dropdown>
    </el-aside>
