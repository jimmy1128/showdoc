      ...
      <div class="container doc-container" id="doc-container">
         <div class="doc-title-box">
            ...
            <div class="tool-bar pull-right">
                ...
                <el-button type="text" @click="edit_page"  v-if="item_info.itempermn && item_info.isarchived < 1" >{{$t('edit')}}</el-button>
                  &nbsp;&nbsp;&nbsp;
                <el-dropdown>
                  ...
                  <el-dropdown-menu slot="dropdown">
                    <router-link :to="'/item/export/'+item_info.id"  v-if="item_info.itempermn"><el-dropdown-item>{{$t('export')}}</el-dropdown-item></router-link>
                    <router-link :to="'/item/setting/'+item_info.id"  v-if="item_info.itemcreator"><el-dropdown-item>{{$t('item_setting')}}</el-dropdown-item></router-link>
...
export default {
  ...
  methods: {
      ...
      that.$http.post(url, params)
        .then(function (response) {
          if (response.data.status === 200) {
            ...
            that.content = response.data.data.pagecontent
    ...
    edit_page () {
      ...
      var url = '/page/edit/' + this.item_info.id + '/' + page_id
      this.$router.push({ path: url })
    },
    share_item () {
      this.share_item_link = this.getRootPath() + '#/' + this.item_info.id
