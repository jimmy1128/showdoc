...
!(function (e) {
  ...
  function i(e) {
    ...
    if (
      ...
      (r = /\blang(?:uage)?-([\w-]+)\b/i.exec(i)))
    )
      return y(r[1]) ? r[1] : "no-highlight";
  ...
  function o(e, a, n) {
    ...
    function s(e) {
      ...
      u +=
        "<" + r(e) + Array.prototype.map.call(e.attributes, a).join("") + ">";
    }
    function c(e) {
      u += "</" + r(e) + ">";
    }
    ...
    function a(n, i) {
      if (!n.compiled) {
        if (((n.compiled = !0), (n.k = n.k || n.bK), n.k)) {
          ...
          "string" == typeof n.k
            ? o("keyword", n.k)
            : Object.keys(n.k).forEach(function(e) {
                o(e, n.k[e]);
              }),
            (n.k = c);
        }
  ...
  function u(e, r, n, i) {
    ...
    try {
      ...
      for (_(r.substr(L)), k = x; k.parent; k = k.parent)
        k.cN && (M += "</span>");
    ...
    e.registerLanguage('css', function (e) {
      ...
      return {
        ...
        c: [
          ...
          { cN: 'selector-pseudo', b: /:(:)?[a-zA-Z0-9\-''.]+/ },
